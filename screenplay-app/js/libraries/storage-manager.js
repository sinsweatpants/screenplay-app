...
// إنشاء نسخة واحدة وتمرير الإعدادات إليها
// نفترض أن APP_CONFIG تم تحميله قبل هذا الملف
const GlobalStorageManager = new StorageManager(window.APP_CONFIG);
window.StorageManager = GlobalStorageManager;